...
export const VotingCardType = ({
  ...
  return (
    <div data-testid="voting-card-type" className={`transition cursor-pointer w-full h-[140px] border-2 border-[#E4E7EB] rounded-lg bg-[#F9FAFB] flex flex-col items-center justify-center ${active ? "border-blue-500 bg-blue-50" : ""}`} onClick={onPress}>
